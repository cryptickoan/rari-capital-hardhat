 ...
 */
export declare function marketInteraction(action: marketInteractionType, cTokenAddress: string, amount: string, provider: Web3Provider | JsonRpcProvider, tokenAddress: string, decimals?: number): Promise<void>;
