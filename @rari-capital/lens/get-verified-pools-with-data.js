...
exports.getVerifiedPoolsWithData = void 0;
 ...
 */
function getVerifiedPoolsWithData(provider, fuse) {
    ...
    return fuse.contracts.FusePoolLens.callStatic.getPublicPoolsByVerificationWithData(false);
}
exports.getVerifiedPoolsWithData = getVerifiedPoolsWithData;
