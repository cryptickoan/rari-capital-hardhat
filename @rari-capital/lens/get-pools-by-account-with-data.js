...
exports.getPoolsByAccountWithData = void 0;
 ...
 */
function getPoolsByAccountWithData(provider, fuse, address) {
    ...
    return fuse.contracts.FusePoolLens.callStatic.getPoolsByAccountWithData(address);
}
exports.getPoolsByAccountWithData = getPoolsByAccountWithData;
