...
const index_1 = __importDefault(require("./addresses/index"));
// ABIs
const FusepoolDirectory_json_1 = __importDefault(require("./contracts/abi/FusepoolDirectory.json"));
const FusePoolLens_json_1 = __importDefault(require("./contracts/abi/FusePoolLens.json"));
const FuseSafeLiquidator_json_1 = __importDefault(require("./contracts/abi/FuseSafeLiquidator.json"));
const FuseFeeDistributor_json_1 = __importDefault(require("./contracts/abi/FuseFeeDistributor.json"));
const FusePoolLensSecondary_json_1 = __importDefault(require("./contracts/abi/FusePoolLensSecondary.json"));
// Contracts
...
const UniswapV3Pool_slim_json_1 = __importDefault(require("./contracts/abi/UniswapV3Pool.slim.json"));
// Types
...
class Fuse {
    constructor(web3Provider, chainId) {
        ...
        if (!(0, networks_1.isSupportedChainId)(chainId)) {
            throw new Error(`unsupported chainid: ${chainId}`);
        }
        this.addresses = index_1.default[chainId];
        this.compoundContracts = compound_protocol_min_json_1.default.contracts;
        this.oracleContracts = oracles_min_json_1.default.contracts;
        this.contracts = {
            FusePoolDirectory: new ethers_1.Contract(this.addresses.FUSE_POOL_DIRECTORY_CONTRACT_ADDRESS, FusepoolDirectory_json_1.default, this.provider),
            FusePoolLens: new ethers_1.Contract(this.addresses.FUSE_POOL_LENS_CONTRACT_ADDRESS, FusePoolLens_json_1.default, this.provider),
            FusePoolLensSecondary: new ethers_1.Contract(this.addresses.FUSE_POOL_LENS_SECONDARY_CONTRACT_ADDRESS, FusePoolLensSecondary_json_1.default, this.provider),
            FuseSafeLiquidator: new ethers_1.Contract(this.addresses.FUSE_SAFE_LIQUIDATOR_CONTRACT_ADDRESS, FuseSafeLiquidator_json_1.default, this.provider),
            FuseFeeDistributor: new ethers_1.Contract(this.addresses.FUSE_FEE_DISTRIBUTOR_CONTRACT_ADDRESS, FuseFeeDistributor_json_1.default, this.provider),
        };
        ...
        whitelist // An array of whitelisted addresses
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!comptrollerImplementationAddress) {
                    const comptrollerContract = new ethers_1.ContractFactory(JSON.parse(this.compoundContracts["contracts/Comptroller.sol:Comptroller"].abi), this.contracts["contracts/Comptroller.sol:Comptroller"].bin, this.provider.getSigner());
                ...
                try {
                    ...
                    // );
                    let contract = types_1.FusePoolDirectory__factory.connect(this.addresses.FUSE_POOL_DIRECTORY_CONTRACT_ADDRESS, this.provider.getSigner());
                ...
                const byteCodeHash = ethers_1.utils.keccak256("0x" + this.compoundContracts["contracts/Unitroller.sol:Unitroller"].bin);
                let poolAddress = ethers_1.utils.getCreate2Address(this.addresses.FUSE_POOL_DIRECTORY_CONTRACT_ADDRESS, saltsHash, byteCodeHash);
                let unitroller = new ethers_1.Contract(poolAddress, JSON.parse(this.compoundContracts["contracts/Unitroller.sol:Unitroller"].abi), this.provider.getSigner());
                ...
                // Whitelist
                if (enforceWhitelist) {
                    let comptroller = new ethers_1.Contract(poolAddress, JSON.parse(this.compoundContracts["contracts/Comptroller.sol:Comptroller"].abi), this.provider.getSigner());
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (model) {
                    ...
                    case "MasterPriceOracle":
                        ...
                        //   this.provider.getSigner()
                        // );
                        let initializableClones = types_1.InitializableClones__factory.connect(this.addresses.INITIALIZABLE_CLONES_CONTRACT_ADDRESS, this.provider.getSigner());
                        let masterPriceOracle = {
                            interface: new abi_1.Interface(oracles_min_json_1.default.contracts["MasterPriceOracle"].abi),
                        };
                        deployArgs = [
                    ...
                    case "UniswapV3TwapPriceOracleV2":
                        ...
                        oracleFactoryContract = new ethers_1.Contract(this.addresses.UNISWAP_V3_TWAP_PRICE_ORACLE_V2_FACTORY_CONTRACT_ADDRESS, this.oracleContracts.UniswapV3TwapPriceOracleV2Factory.abi, this.provider.getSigner());
                    ...
                    case "UniswapTwapPriceOracleV2":
                        ...
                        // Check for existing oracle
                        oracleFactoryContract = new ethers_1.Contract(this.addresses.UNISWAP_TWAP_PRICE_ORACLE_V2_FACTORY_CONTRACT_ADDRESS, this.oracleContracts.UniswapTwapPriceOracleV2Factory.abi, this.provider.getSigner());
        ...
        options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!implementationAddress) {
                    const comptrollerContract = new ethers_1.Contract(JSON.parse(this.compoundContracts["contracts/Comptroller.sol:Comptroller"].abi), this.compoundContracts["contracts/Comptroller.sol:Comptroller"].bin, this.provider.getSigner());
                ...
                const unitrollerContract = new ethers_1.ContractFactory(JSON.parse(this.compoundContracts["contracts/Unitroller.sol:Unitroller"].abi), this.compoundContracts["contracts/Unitroller.sol:Unitroller"].bin, this.provider.getSigner());
        ...
        this.deployInterestRateModel = function (model, conf, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const interestRateModelContract = new ethers_1.ContractFactory(JSON.parse(this.compoundContracts["contracts/" + model + ".sol:" + model].abi), this.compoundContracts["contracts/" + model + ".sol:" + model].bin, this.provider.getSigner());
        ...
        this.deployCToken = function (conf, collateralFactor, reserveFactor, adminFee, options, bypassPriceFeedCheck) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const collateralFactorBN = ethers_1.BigNumber.from(collateralFactor); // TODO: find out if this is a number or string. If its a number, parseUnits will not work. Also parse Units works if number is between 0 - 0.9
                // Check collateral factor
                if (collateralFactorBN.lt(ethers_1.constants.Zero) ||
                    collateralFactorBN.gt(ethers_1.utils.parseEther("0.9")))
                ...
                if (reserveFactorBN.gt(ethers_1.constants.Zero) || adminFeeBN.gt(ethers_1.constants.Zero)) {
                    ...
                    if (reserveFactorBN
                        .add(adminFeeBN)
                        .add(ethers_1.BigNumber.from(fuseFee))
                        .gt(ethers_1.constants.WeiPerEther))
        ...
        this.deployCEther = function (conf, collateralFactor, reserveFactor, adminFee, implementationAddress, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!implementationAddress) {
                    const cEtherDelegateFactory = new ethers_1.ContractFactory(JSON.parse(this.compoundContracts["contracts/CEtherDelegate.sol:CEtherDelegate"].abi), this.compoundContracts["contracts/CEtherDelegate.sol:CEtherDelegate"].bin, this.provider.getSigner());
                ...
                const saltsHash = ethers_1.utils.solidityKeccak256(["address", "address", "uint"], [
                    conf.comptroller,
                    "0x0000000000000000000000000000000000000000",
                    receipt.blockNumber,
                ]);
                const byteCodeHash = ethers_1.utils.keccak256("0x" +
                    this.compoundContracts["contracts/CEtherDelegator.sol:CEtherDelegator"].bin);
                const cEtherDelegatorAddress = ethers_1.utils.getCreate2Address(this.addresses.FUSE_FEE_DISTRIBUTOR_CONTRACT_ADDRESS, saltsHash, byteCodeHash);
        ...
        this.deployCErc20 = function (conf, collateralFactor, reserveFactor, adminFee, options, bypassPriceFeedCheck, implementationAddress // cERC20Delegate implementation
            ...
            return __awaiter(this, void 0, void 0, function* () {
                // Get Comptroller
                let comptroller = new ethers_1.Contract(conf.comptroller, JSON.parse(this.compoundContracts["contracts/Comptroller.sol:Comptroller"].abi), this.provider.getSigner());
                ...
                if (!implementationAddress) {
                    ...
                    const cErc20Delegate = new ethers_1.ContractFactory(JSON.parse(this.compoundContracts["contracts/" +
                ...
                const constructorData = new ethers_1.utils.AbiCoder().encode([
                    "address",
                    "address",
                    "address",
                    "string",
                ...
                const cErc20DelegatorAddress = ethers_1.utils.getCreate2Address(this.addresses.FUSE_FEE_DISTRIBUTOR_CONTRACT_ADDRESS, saltsHash, byteCodeHash);
                // Return cToken proxy and implementation contract addresses
        ...
        this.getInterestRateModel = function (assetAddress) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const assetContract = new ethers_1.Contract(assetAddress, JSON.parse(this.compoundContracts["contracts/CTokenInterfaces.sol:CTokenInterface"].abi), this.provider);
        ...
        this.deployRewardsDistributor = function (rewardToken, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const distributor = new ethers_1.ContractFactory(JSON.parse(this.compoundContracts["contracts/RewardsDistributorDelegator.sol:RewardsDistributorDelegator"].abi), this.compoundContracts["contracts/RewardsDistributorDelegator.sol:RewardsDistributorDelegator"].bin, this.provider.getSigner());
        ...
        this.checkCardinality = function (uniswapV3Pool) {
            return __awaiter(this, void 0, void 0, function* () {
                var uniswapV3PoolContract = new ethers_1.Contract(uniswapV3Pool, UniswapV3Pool_slim_json_1.default, this.provider);
        ...
        this.primeUniswapV3Oracle = function (uniswapV3Pool, options) {
            return __awaiter(this, void 0, void 0, function* () {
                var uniswapV3PoolContract = new ethers_1.Contract(uniswapV3Pool, UniswapV3Pool_slim_json_1.default, this.provider.getSigner());
