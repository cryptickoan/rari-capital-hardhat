...
class DAIInterestRateModelV2 extends JumpRateModel_js_1.default {
    init(interestRateModelAddress, assetAddress, provider) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const interestRateContract = (0, web3_1.createContract)(interestRateModelAddress, compound_protocol_min_json_1.contracts["contracts/DAIInterestRateModelV2.sol:DAIInterestRateModelV2"]
                .abi, provider);
            this.dsrPerBlock = (0, web3_1.toBN)(yield interestRateContract.callStatic.dsrPerBlock());
            const cTokenContract = (0, web3_1.createContract)(assetAddress, compound_protocol_min_json_1.contracts["contracts/CTokenInterfaces.sol:CTokenInterface"].abi, provider);
